...
public:
    ...
    // Getter(s) for vector of Nodes, Ways, Roads, etc
...
private:
    // Adjusts the OpenStreetMap node coordinates
    void AdjustCoordinates();
    // Building objects in the OpenStreetMap model
    void BuildRings( Multipolygon &mp );
    // Parse XML data and storing all of that data into vectors below
    ...
    double m_MinLon = 0.;
    double m_MaxLon = 0.;
    // Use to convert the scale of the model to meters
